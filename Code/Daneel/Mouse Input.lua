...
function MouseInput.Load()
    ...
    if Daneel.modules.Tags == nil then
        MouseInput.Update = nil
        error( "MouseInput.Load(): the 'Tags' module (the CraftStudio script) is missing." )
    end
end
...
function MouseInput.New( gameObject, params )
    if gameObject.camera == nil then
        error( "MouseInput.New() : "..tostring(gameObject).." has no Camera component." )
        return
    end
                ...
                for j=1, #component.tags do
                    ...
                    if gameObjects ~= nil then
                        ...
                        for k=1, #gameObjects do
                            ...
                            -- gameObject is the game object whose position is checked agaisnt the raycasthit
